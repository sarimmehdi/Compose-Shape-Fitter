...
fun getDrawableShapeFromShape(shape: Shape) = when (shape) {
    ...
    Shape.OrientedRectangle -> ObbShape(Color.Blue,
        DEFAULT_STROKE_WIDTH, allSidesEqual = true, inPreviewMode = true)
    Shape.OrientedSquare -> ObbShape(Color.Blue,
        DEFAULT_STROKE_WIDTH, allSidesEqual = false, inPreviewMode = true)
