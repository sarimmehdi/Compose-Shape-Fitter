...
data class TestData(
    ...
    val testDescription = ("when the input event is $inputEvent " +
...
class DrawingScreenViewModelOnEventTest(
    ...
    fun test() = runTest {
        ...
        testData.outputUseCase?.let {
            if (it is UpdateSelectedShapeUseCase) {
                ...
                fail("$it is a usecase that is not one of these: " +
    ...
    companion object {
        val drawingScreenUseCases = mockk<DrawingScreenUseCases>(relaxed = true) {
        ...
        fun getParameters(): Collection<Array<Any>> {
            ...
            val testDataList = DrawingScreenToViewModelEvents::class.sealedSubclasses.flatMap {
                when (it) {
                    ...
                    DrawingScreenToViewModelEvents.SetLines::class -> {
                        listOf(
                            TestData(
                                inputEvent = DrawingScreenToViewModelEvents.SetLines(
                                    persistentListOf(
                    ...
                    DrawingScreenToViewModelEvents.UpdateLines::class -> {
                        listOf(
                            TestData(
                                inputEvent = DrawingScreenToViewModelEvents.UpdateLines(
                                    Pair(Offset.Infinite, Offset.Zero),
                                ),
                                inputState = DrawingScreenState(),
                                outputState = DrawingScreenState(
                    ...
                    DrawingScreenToViewModelEvents.SetPoints::class -> {
                        listOf(
                            TestData(
                                inputEvent = DrawingScreenToViewModelEvents.SetPoints(
                    ...
                    DrawingScreenToViewModelEvents.UpdatePoints::class -> {
                        listOf(
                            TestData(
                                inputEvent = DrawingScreenToViewModelEvents.UpdatePoints(
                                    Offset.Infinite,
                                ),
                                inputState = DrawingScreenState(),
                                outputState = DrawingScreenState(
                    ...
                    DrawingScreenToViewModelEvents.SetApproximateShape::class -> {
                        ...
                        listOf(
                            TestData(
                                inputEvent = DrawingScreenToViewModelEvents.SetApproximateShape(
                                    approximatedShape
                                ),
                                inputState = DrawingScreenState(),
                                outputState = DrawingScreenState(
