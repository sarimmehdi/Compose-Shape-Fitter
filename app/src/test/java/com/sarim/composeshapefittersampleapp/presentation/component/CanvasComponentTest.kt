...
data class TestData(
    ...
    val testDescription = "when you start dragging from $dragStart, " +
...
class DrawingScreenTest(
    ...
    companion object {
        ...
        fun getParameters(): Collection<Array<Any>> {
            ...
            val allDragPositionsAndResultingDrawableShape= listOf(
            ...
            val allTestData = allDragPositionsAndResultingDrawableShape.map {
                listOf(
                    TestData(
